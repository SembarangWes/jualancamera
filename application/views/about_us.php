		...
		<div class="container">
			...
			<div class="wthree_team_grids">
				<div class="col-md-3 wthree_team_grid">
					<img src="<?php echo base_url('assets/')?>images/t4.png" alt=" " class="img-responsive" />
				...
				<div class="col-md-3 wthree_team_grid">
					<img src="<?php echo base_url('assets/')?>images/t5.png" alt=" " class="img-responsive" />
				...
				<div class="col-md-3 wthree_team_grid">
					<img src="<?php echo base_url('assets/')?>images/t6.png" alt=" " class="img-responsive" />
				...
				<div class="col-md-3 wthree_team_grid">
					<img src="<?php echo base_url('assets/')?>images/t7.png" alt=" " class="img-responsive" />
