...
<?php if(isset($data)) { ?>
									<tbody>
										...
										<td>
                                            <!-- Tombol Modal Ubah-->
                                            <button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#ModalUbah<?php echo $row->id_user ?>">Ubah</button>
...
<!-- Tutup Modal Ubah -->
											...
											<a href="<?php echo site_url('user/destroy/'.$row->id_user) ?>" type="button" class="btn btn-danger btn-sm"
